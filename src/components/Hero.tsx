    ...
    <section className="hero" id="inicio">
      <div className="hero-container">
        <div className="hero-content">
          <h1 className="hero-title">Bienvenido a 41 Hair Studio</h1>
          <p className="hero-subtitle">
            Tu barbería de confianza en Sevilla. Ofrecemos servicios profesionales 
            de peluquería y barbería con un estilo único y personalizado. 
            Nuestro equipo de expertos está comprometido con la excelencia 
